...
# standalone package directory (isaacsim-zmq/run.sh). It is not part of the source repo.
#
# Notes:
...
echo ""
echo "Note:"
echo "  - run.sh is generated inside the extracted package (isaacsim-zmq/run.sh)."
