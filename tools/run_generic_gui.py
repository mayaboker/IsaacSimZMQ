    ...
    async def setup_streaming():
        ...
        if use_pose_subscriber:
            try:
                ...
                print(f"[run_generic_gui] WARNING: Pose subscriber unavailable: {e}")
                print("[run_generic_gui] Install msgpack in Isaac Sim: /home/user/isaacsim5.0/python.sh -m pip install msgpack")
